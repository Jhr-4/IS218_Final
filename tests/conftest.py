...
def admin_token(admin_user):
    ...
    token_data = {"sub": str(admin_user.email), "role": admin_user.role.name} #was id is supposed to be email as thats what was used in the other code... like dependencies.py
